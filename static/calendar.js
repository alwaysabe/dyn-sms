        ...
        */
        ...
        imgUp.src = '/static/images/up.gif';
        var imgDown = new Image(8,12);
        imgDown.src = '/static/images/down.gif';
        ...
        function handleDocumentClick(e){
          ...
          if (typeof g_Calender == 'undefined')
              return;
          if (browser.ns6){
        ...
        // the body tag
        calendar_window_onload=function(){ 
	...
	//        window.onload=calendar_window_onload;
        ...
        window.onerror = function(msg,url,line){
          ...
          'Please check that you have not added any code to the body onload event.\n' +
          + 'Error details:\n'
          + 'Text:' + msg + 'url:' + url + 'line:' + line);
        }
